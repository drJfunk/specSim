...
bbGrid = np.loadtxt("/Users/jburgess/Research/specSim/bbGrid_fast_300.txt")
kT = bbGrid[:,0]
frac = bbGrid[:,1]
...
interpTable = np.loadtxt("/Users/jburgess/Research/specSim/epflux2.txt")
...
cpdef float evo(float ene, float t):
    ...
    #SN = 30.
    #bkg = 265.64
    synch = 100.*synchrotronFast(ene,3.2499E-0,Estar,2.5,90.)/renorm(Estar) 
